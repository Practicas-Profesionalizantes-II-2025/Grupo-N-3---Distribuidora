            ...
            modelBuilder.Entity("Shared.Entities.Ciudades", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(3970));
            ...
            modelBuilder.Entity("Shared.Entities.Clientes", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(4318));
            ...
            modelBuilder.Entity("Shared.Entities.Distribuidores", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(4823));
            ...
            modelBuilder.Entity("Shared.Entities.Empleados", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(5178));
            ...
            modelBuilder.Entity("Shared.Entities.Estados", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(7602));
            ...
            modelBuilder.Entity("Shared.Entities.Facturas", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(5597));
            ...
            modelBuilder.Entity("Shared.Entities.OrdenesDeCompra", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(6173));
            ...
            modelBuilder.Entity("Shared.Entities.OrdenesDeCompra_Producto", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(6607));
            ...
            modelBuilder.Entity("Shared.Entities.OrdenesDeVenta", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(7107));
            ...
            modelBuilder.Entity("Shared.Entities.Personas", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(1906));
            ...
            modelBuilder.Entity("Shared.Entities.Productos", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(2745));
            ...
            modelBuilder.Entity("Shared.Entities.TipoDocumento", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 23, 34, 36, 683, DateTimeKind.Local).AddTicks(3168));
