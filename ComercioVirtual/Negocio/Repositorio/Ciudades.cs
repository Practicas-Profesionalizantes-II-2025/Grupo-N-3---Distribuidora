...
namespace Negocio.Repositorio
{
    ...
    {
        public static async Task<List<Shared.Entities.Ciudades>> Get()
        {
            try
            {
                    ...
                    .GetAsync(
                        ApiServer.ObtenerUrlEndPoint(
                            ApplicationConfiguration.GetSetting(
                                "ApiServer:EndPoints:Ciudades:ObtenerTodo"
                            )
                        )
                    );
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    var returnModel = JsonConvert.DeserializeObject<List<Shared.Entities.Ciudades>>(
                        result
                    );
        ...
        public static async Task<Shared.Entities.Ciudades?> Get(int id)
        {
            try
            {
                string path = ApplicationConfiguration.GetSetting(
                    "ApiServer:EndPoints:Ciudades:ObtenerPorId"
                );
                ...
                {
                    var result = await response.Content.ReadAsStringAsync();
                    var returnModel = JsonConvert.DeserializeObject<Shared.Entities.Ciudades>(result);
        ...
        public static async Task<List<Shared.Entities.Ciudades>?> Get(string nombre)
        {
            try
            {
                string path = ApplicationConfiguration.GetSetting(
                    "ApiServer:EndPoints:Ciudades:ObtenerPorNombre"
                );
        ...
        public static async Task<Shared.Entities.Ciudades> Create(Shared.Dtos.Ciudades.CrearDTOCiudades Ciudades)
        {
            try
            {
                string path = ApplicationConfiguration.GetSetting("ApiServer:EndPoints:Ciudades:Crear");
                var stringContent = new StringContent(
                    JsonConvert.SerializeObject(Ciudades),
                    Encoding.UTF8,
                    "application/json"
                );
        ...
        public static async Task Delete(int id)
        {
            ...
            {
                string path = ApplicationConfiguration.GetSetting(
                    "ApiServer:EndPoints:Ciudades:Borrar"
                );
                path = string.Format(path, id);
        ...
        public static async Task<Shared.Entities.Ciudades> Update(
            int id,
            Shared.Dtos.Ciudades.ModificarDTOCiudades Ciudades
        )
        {
            try
            {
                string path = ApplicationConfiguration.GetSetting(
                    "ApiServer:EndPoints:Ciudades:Actualizar"
                );
                path = string.Format(path, id);
                var stringContent = new StringContent(
                    JsonConvert.SerializeObject(Ciudades),
